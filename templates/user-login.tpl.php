...
<div class="container">    
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">        
            ...
            <div class="panel panel-default" >
                    <div class="panel-heading" style="background-color: #08167A;color:#fff">
                        <div class="panel-title"><marquee> LOGIN APLIKASI MAHASISWA </marquee></div>
                    ...
                    <div style="padding-top:30px; background:url(http://local.ut.ac.id/sites/all/themes/garudanya-ut/images/utfooter.png) bottom no-repeat" class="panel-body" >
